...
public class TC_017_ReadingDataFromExcel {
	...
	public static void main(String[] args) throws IOException {
		...
		//int lastCellNumber = sheet.getRow(0).getLastCellNum(); // Last Cell Number of Row[0] in Sheet "SignUP' 
		
		// Null check for empty row
		XSSFRow row0 = sheet.getRow(0);
		int lastCellNumber = (row0==null)? 0 :row0.getLastCellNum();
		//ternary operator (a shorthand if/else statement), which is evaluated as:
